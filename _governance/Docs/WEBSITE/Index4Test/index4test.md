...
<head>
  ...
  <title>LEGAiSEE — Business Archaeology & Authority Systems</title>
    ...
    <link rel="stylesheet" href="https://www.legaisee.com/legaisee-design-system/assets/css/legaisee.css">
    <link rel="stylesheet" href="https://www.legaisee.com/legaisee-design-system/assets/css/legaisee-luxury.css" />
...
<section class="hero-vault">
  ...
  <div class="hero-content">
    <div class="vault-seal-ring", padding-top="100px">
      <span class="vault-seal-inner">L</span>
    </div>
    <div class=""vault-seal-ring"">
        <img src="https://www.legaisee.com/Images/Legaisee-sm-300.PNG", margin-bottom: "80px">
    </div>
...
<!-- ═══════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════ -->
<section class="velvet-rope-section lux-section" style="overflow: hidden; background: var(--obsidian); padding-top: 140px; padding-bottom: 140px;">
  ...
  <div class="velvet-content">
    ...
    <div style="max-width: 900px; margin: 64px 0 0;" class="reveal reveal-d2">
      <div class="signal-block">
        ...
        <p style="font-family: var(--font-ui); font-size: clamp(1.1rem, 1.8vw, 1.45rem); font-style: italic; color: var(--gold-bright); line-height: 1.85;">
...
<!-- ═══════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════ -->
<section class="lux-section thesis-reveal" style="overflow: hidden; padding-top: 160px; padding-bottom: 160px; background: var(--obsidian-light);">
    ...
    <div class="asym-grid-a" style="align-items: start;">
      ...
      <div>
        ...
        <div class="signal-block reveal reveal-d3">
          ...
          <p style="font-family: var(--font-ui); font-size: 1.12rem; font-style: italic; color: var(--gold-bright); line-height: 1.82;">
...
<!-- ═══════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════ -->
<section class="lux-section" data-light="4" style="overflow: hidden; background: var(--obsidian); padding-top: 160px; padding-bottom: 100px;">
    ...
    <div class="two-col" style="align-items: center; gap: 90px;">
      ...
      <div>
        ...
        <div class="signal-block reveal reveal-d3">
          ...
          <p style="font-family: var(--font-ui); font-size: 1.18rem; font-style: italic; color: var(--gold-bright); line-height: 1.82;">
...
<!-- ═══════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════ -->
<section class="lux-section" data-light="5" style="background: var(--obsidian-mid); padding-top: 140px; padding-bottom: 80px; position: relative; overflow: hidden;">
  <div style="position: absolute; inset: 0; background-image: url('http://www.legaisee.com/Images/Library2Diamond.png'); background-size: cover; background-position: center; background-attachment: fixed; /* mobile: scroll via CSS */ opacity: 0.09; z-index: 0;"></div>
...
<!-- ═══════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════ -->
<section class="lux-section" data-light="6" style="overflow: hidden; background: var(--obsidian); padding-top: 140px; padding-bottom: 140px;">
  <div class="section-inner">
...
<!-- ═══════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════ -->
<section class="lux-section" data-light="7" style="background: var(--obsidian-light); padding-top: 140px; padding-bottom: 100px; position: relative; overflow: hidden;">
  <div style="position: absolute; inset: 0; background-image: url('http://www.legaisee.com/Images/LapidaryVerticleBlue.png'); background-size: cover; background-position: center; background-attachment: fixed; /* mobile: scroll via CSS */ opacity: 0.11; z-index: 0;"></div>
...
<!-- ═══════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════ -->
<section class="lux-section" style="overflow: hidden; background: var(--obsidian); padding-top: 140px; padding-bottom: 100px;">
  <div class="section-inner">
    ...
    <div class="asym-grid-b" style="align-items: center; gap: 80px;">
      ...
      <div class="reveal reveal-right" style="display: flex; flex-direction: column; gap: 0;">
        ...
        <div class="speakeasy-frame reveal reveal-d1" style="padding: 28px 32px; margin-top: 16px;">
          <p style="font-family: var(--font-ui); font-size: 1rem; font-style: italic; color: var(--silver); line-height: 1.75; position: relative; z-index: 1;">
            The work is private. The results are documented in boardrooms, not blog posts.
          </p>
...
<!-- ═══════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════ -->
<section class="final-cta lux-section" style="overflow: hidden; padding-top: 160px; padding-bottom: 160px;">
  ...
  if (window.innerWidth > 1024) {
    document.querySelectorAll('.gem-frame, .museum-card').forEach(el => {
      ...
      el.addEventListener('mousemove', (e) => {
        ...
        el.style.transform =
          `perspective(800px) rotateY(${x}deg) rotateX(${-y}deg) translateY(-6px)`;
      });
