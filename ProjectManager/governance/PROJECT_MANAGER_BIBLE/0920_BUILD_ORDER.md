...
After Batch 5 is complete:
Run migration.php
Validate the 8 database tables
Run Batch 4 database tests
The error exposed a sequencing problem. The architecture itself is still intact.
