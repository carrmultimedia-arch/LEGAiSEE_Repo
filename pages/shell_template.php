...
<div class="lobby">
    ...
    <section class="wing-grid">
        <?php foreach ($wings as [$label, $title, $module]): ?>
        <div class="wing">
            <div class="wing-label"><?= htmlspecialchars($label) ?></div>
            <div class="wing-title"><?= htmlspecialchars($title) ?></div>
            <div class="pedestal"><?= renderModule($module) ?></div>
        </div>
        <?php endforeach; ?>
    </section>
</div>
